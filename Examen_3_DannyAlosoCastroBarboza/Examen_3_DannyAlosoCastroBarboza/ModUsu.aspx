<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="ModUsu.aspx.cs" Inherits="Examen_3_DannyAlosoCastroBarboza.ModUsu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/tablagrid.css" rel="stylesheet" />
    <link href="css/wrap.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <div class="titulo"><p class="titulo">Modificar Usuario </p>
     </div>
    <div>
    ...
    <h2><p class="ingresar">  codigo: <asp:TextBox  ID="Tcodigo" class="input100" placeholder="Digitar el codigo a modificar" runat="server"> </asp:TextBox></p></h2></div>
     

                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
    <h2><p class="ingresar">  Usuario: <asp:TextBox  ID="TUsuario" class="input100" placeholder="Digitar un Usuario" runat="server"> </asp:TextBox></p></h2></div>
     

    <div class="wrap-input100 validate-input" data-validate = "Enter username">
    <h2><p class="ingresar">  Clave: <asp:TextBox  ID="TClave" class="input100" placeholder="Digite una clave" runat="server"> </asp:TextBox></p></h2></div>
   ...
   <div class="wrap-input100 validate-input" data-validate = "Enter username">
    <h2><p class="ingresar">  Nombre: <asp:TextBox  ID="Tnombre" class="input100" placeholder="Digite el nombre" runat="server"> </asp:TextBox></p></h2></div>
     ...
     <div class="wrap-input100 validate-input" data-validate = "Enter username">
    <h2><p class="ingresar">  Apellido: <asp:TextBox  ID="Tapellido" class="input100" placeholder="Digite los apellidos" runat="server"> </asp:TextBox></p></h2></div>
     

    <div class="container-login100-form-btn">
    <asp:Button ID="Bingresar" runat="server" class="login100-form-btn" Text="Modificar Usuario" OnClick="Bingresar_Click"  />
                </div>
