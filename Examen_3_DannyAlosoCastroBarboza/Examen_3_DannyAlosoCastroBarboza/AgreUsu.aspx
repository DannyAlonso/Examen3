<%@ Page Title="" Language="C#" MasterPageFile="~/MenuPrincipal.Master" AutoEventWireup="true" CodeBehind="AgreUsu.aspx.cs" Inherits="Examen_3_DannyAlosoCastroBarboza.AgreUsu" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <link href="css/tablagrid.css" rel="stylesheet" />
    <link href="css/wrap.css" rel="stylesheet" />
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       <div class="titulo"><p class="titulo">Agregar Usuario </p>
     </div>
    <div>
   ...
   <div class="wrap-input100 validate-input" data-validate = "Enter username">
    ...
    <asp:Button ID="Bingresar" runat="server" class="login100-form-btn" Text="Ingresar Usuario" OnClick="Bingresar_Click" />
                </div>
